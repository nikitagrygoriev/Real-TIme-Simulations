 ...
 * Third is the task priority ( 0), fourth is the stack size ( 0 bytes) and 
 * last is the subprogram executed by the task
 */
  __po_hi_create_periodic_task (pr_a_producer_k, &(period), __PO_HI_DEFAULT_PRIORITY, 0, 0, producer_job);
  
/*!
 * Store the period time for task computer
 */
  __po_hi_milliseconds (&(period), 1000);
 ...
 */
  __po_hi_create_sporadic_task (pr_a_computer_k, &(period), __PO_HI_DEFAULT_PRIORITY, 0, 0, computer_job);
  
/*!
 * Store the period time for task consumer
 */
  __po_hi_milliseconds (&(period), 1000);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (pr_a_consumer_k, &(period), __PO_HI_DEFAULT_PRIORITY, 0, 0, consumer_job);
