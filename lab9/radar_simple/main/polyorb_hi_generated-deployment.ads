...
package PolyORB_HI_Generated.Deployment is
  ...
  type Port_Type is
   (main_receive_receiver_out_K,
    main_receive_receiver_in_K,
    main_analyse_from_transmitter_K,
    main_analyse_from_receiver_K,
    main_analyse_analyser_out_K,
    main_analyse_from_controller_K,
    main_display_display_in_K,
    main_display_display_out_K,
    main_transmit_transmitter_out_K,
    main_control_angle_controller_in_K,
    main_control_angle_controller_out_K);
  ...
  --  Biggest type: target_position_impl
